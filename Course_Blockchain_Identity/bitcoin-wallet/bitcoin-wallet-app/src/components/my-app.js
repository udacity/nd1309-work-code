...
class MyApp extends LitElement {
  render() {
    ...
    <footer>
      <p>Udacity - Blockchain Developer ND 2018</p>
    </footer>
  ...
  _locationChanged() {
    ...
    const page = path === '/' ? 'walletinfo' : path.slice(1);
    this._loadPage(page);
  ...
  _loadPage(page) {
    switch(page) {
      case 'walletinfo':
        import('../components/my-walletinfo.js').then((module) => {
          // Put code in here that you want to run every time when
          // navigating to view1 after my-view1.js is loaded.
        });
        break;
      case 'signature':
        import('../components/my-signature.js').then((module) => {
          // Put code in here that you want to run every time when
          // navigating to view1 after my-view1.js is loaded.
        });
        break;
